...
namespace MSDF.DataChecker.cmd.Helpers
{
    static class CommandLine
    {
        ...
        public static RootCommand GetCommandLineParameters()
        {
            ...
            rootCommand.Description = "MSDF.DataChecker.WebApp.Cmd (Example of parameters :  --connString Server=localhost;Port=5432;Database=DataCheckerPersistence1;User Id=postgres;Password=******)";
            return rootCommand;
        }
        ...
        public static DatabaseEnvironmentBO BuildDatabaseEnvironment(string connString)
        {
