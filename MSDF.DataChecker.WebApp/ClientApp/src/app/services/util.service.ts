...
export class UtilService {
  ...
  static communityUrl: any = function () {
    if (UtilService.communityUrlUser == null || UtilService.communityUrlUser == environment.communityUrl)
      return environment.communityUrl;

    return UtilService.communityUrlUser;
  };

  static currentUserId: any = function () {
    return "661BFE54-ED59-4D59-B771-005F25F8356D";
  };

  static compareObj: any = function (obj1: any, obj2: any) {
